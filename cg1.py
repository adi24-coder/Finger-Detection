...
# Open Camera
capture = cv2.VideoCapture(0)  # Use 0 for default camera, change to 1 or higher for additional cameras
    ...
    try:
        ...
        if defects is not None:
            for i in range(defects.shape[0]):
                ...
                # If angle is less than 90, draw a circle at the far point
                if angle <= 90:
                    count_defects += 1
